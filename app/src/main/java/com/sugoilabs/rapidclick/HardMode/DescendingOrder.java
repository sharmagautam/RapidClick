...
public class DescendingOrder extends AppCompatActivity implements View.OnClickListener
{
    GridView gridview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogbox=new CommonDialogbox(DescendingOrder.this);
        dialogbox.instructionDialog("Select numbers (50 to 1) displayed on the screen in descending order as fast as you can. Screen resets itself if you click a number in wrong sequence.",countDownTimer);
...
*/
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                {
                    CommonDialogbox  dialogbox=new CommonDialogbox(DescendingOrder.this);
                    dialogbox.showGameOverDialog("levelhard_2");
                ...
                if(count==50)
                {
                   // Toast.makeText(DescendingOrder.this,"50", Toast.LENGTH_LONG).show();
                    editor.putString("levelhard2","l2_complete");
                    editor.commit();

                    CommonDialogbox  dialogbox=new CommonDialogbox(DescendingOrder.this);
                    dialogbox.showscoreDialog("levelhard_2",time_insecond,countte);
                }
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.imgpause:
                ...
                countDownTimer.cancel();
                dialogbox=new CommonDialogbox(DescendingOrder.this);
                dialogbox.PauseDialog(countDownTimer,"levelhard_2");
