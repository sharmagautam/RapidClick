...
public class Easymode_alphabates_descending_order extends AppCompatActivity implements View.OnClickListener
{
    GridView gridview;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_easymode_alphabates_descending_order);
        ...
        dialogbox=new CommonDialogbox(Easymode_alphabates_descending_order.this);
        dialogbox.instructionDialog("Select alphabets (Z to A) displayed on the screen in descending order with minimum number clicks and as fast as possible.",countDownTimer);
...
*/
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                if(count==26)
                {
                   // Toast.makeText(Easymode_alphabates_descending_order.this,"26", Toast.LENGTH_LONG).show();
                    editor.putString("leveleasy4","l4_complete");
                    editor.commit();

                    CommonDialogbox  dialogbox=new CommonDialogbox(Easymode_alphabates_descending_order.this);
                    dialogbox.showscoreDialog("leveleasy_4",time_insecond,countte);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.imgpause:
                ...
                countDownTimer.cancel();
                dialogbox=new CommonDialogbox(Easymode_alphabates_descending_order.this);
                dialogbox.PauseDialog(countDownTimer,"leveleasy_4");
